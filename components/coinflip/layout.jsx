...
const S = {
  page:    { boxSizing: "border-box", background: "linear-gradient(180deg, rgba(10,11,20,0.35) 0%, rgba(10,11,20,0.78) 40%, #0a0b14 100%), url(/bg-coinflip.png) center top / cover no-repeat fixed", minHeight: "100%", color: "#fff", fontFamily: "system-ui,-apple-system,sans-serif" },
