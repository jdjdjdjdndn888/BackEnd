...
export default function Header({ onOpenMobileNav = () => {} }) {
  ...
  return (
    <header className="box-border flex h-[var(--header-height)] items-center gap-3 px-4 border-b border-[#16182e] bg-[#0b0d18] relative">
      ...
      {userData ? (
        <>
          ...
          <div className="flex-1 flex justify-center items-center gap-2">
            ...
            <NormalWalletChip balance={normalBalance ?? 0} onClick={() => Navigate("/normal-wallet")} />
          </div>
...
const NormalWalletChip = ({ balance, onClick }) => (
  <button
    type="button"
    onClick={onClick}
    className="hidden sm:flex items-center gap-1.5 rounded-xl border border-[#1e2035] bg-[#13151f] text-xs font-semibold text-white sm:text-sm px-3 py-2 transition-all hover:border-[#8B5CF6] hover:bg-[#1a1630] active:scale-95 cursor-pointer"
