...
const S = {
  page:    { boxSizing: "border-box", background: "linear-gradient(180deg, rgba(4,12,8,0.45) 0%, rgba(4,12,8,0.82) 55%, #040c08 100%), url(/bg-dice.jpg) center/cover no-repeat fixed", minHeight: "100%", color: "#fff", fontFamily: "system-ui,-apple-system,sans-serif" },
