...
const Button = ({ action, children, className }) => {
  ...
  return (
    <button
      type="button"
      className={cn(
        "mt-auto box-border inline-flex cursor-pointer items-center gap-2 rounded-lg border-none bg-[#8B5CF6] px-2 py-1.5 text-sm font-semibold text-white transition-colors hover:bg-[#7C3AED] active:bg-[#8B5CF6] sm:px-6 sm:py-3",
        className,
      )}
