    ...
    >
      <div className={`${AccountStyles.userinfo} ${rankColor}`}>
        ...
        <div className={AccountStyles.discordWrapper}>
          <button
            onClick={() =>
              userData?.discordid ? unlinkdiscord() : (location.href = discordOAuthURL)
            }
      ...
      <div className={AccountStyles.history}>
        <p>
          {historyLoading ? "Loading history..." : `Page ${page} of ${totalPages || 1}`}
        </p>
        <div className={AccountStyles.historyList}>
          ...
          {historyLoading ? (
            <div className={AccountStyles.historyItem}>
              <p style={{ gridColumn: "1 / -1", textAlign: "center", color: "#68749C" }}>Loading...</p>
            </div>
          ) : history.length === 0 ? (
            <div className={AccountStyles.historyItem}>
              <p style={{ gridColumn: "1 / -1", textAlign: "center", color: "#68749C" }}>No history yet.</p>
            </div>
          ) : (
            [...history]
