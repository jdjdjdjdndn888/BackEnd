...
const S = {
  page:    { boxSizing: "border-box", background: "linear-gradient(180deg, rgba(4,8,16,0.45) 0%, rgba(4,8,16,0.82) 55%, #040810 100%), url(/bg-blackjack.png) center/cover no-repeat fixed", minHeight: "100%", color: "#fff", fontFamily: "system-ui,-apple-system,sans-serif" },
