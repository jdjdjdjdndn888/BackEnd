...
// Escape special regex characters from user-controlled input to prevent ReDoS / injection
const escapeRegex = (str) => str.replace(/[.*+?^${}()|[\]\\]/g, "\\const userCodes = {};

exports.real = asyncHandler((req, res, next) => {");

// Validate that a userId is a safe positive integer
...
const resolveDepositWithdrawStatus = async (userId, game) => {
  ...
  const gameRegex = new RegExp(`^${escapeRegex(game)}const asyncHandler = require("express-async-handler");
const { jwt_secret, botlogs } = require("../../config.js");
const { logEvent } = require("../../logger.js");
const users = require("../../modules/users.js");
const inventorys = require("../../modules/inventorys.js");
...
exports.Deposit = asyncHandler(async (req, res) => {
  ...
  if (itemList.length > 0) {
    ...
    const gameRegex = game ? new RegExp(`^${escapeRegex(game)}const asyncHandler = require("express-async-handler");
const { jwt_secret, botlogs } = require("../../config.js");
const { logEvent } = require("../../logger.js");
const users = require("../../modules/users.js");
const inventorys = require("../../modules/inventorys.js");
...
, "i") : null;
    const itemQueries = Object.keys(uniqueItems).map(itemName => {
      const query = {
        itemname: { $regex: new RegExp(`^${escapeRegex(itemName)}const asyncHandler = require("express-async-handler");
const { jwt_secret, botlogs } = require("../../config.js");
const { logEvent } = require("../../logger.js");
const users = require("../../modules/users.js");
const inventorys = require("../../modules/inventorys.js");
