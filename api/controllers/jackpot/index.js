...
exports.join_jackpot = [
  asyncHandler(async (req, res, next) => {
    ...
    try {
      // Guard against joining while the round is actively rolling.
      // This check must run before the transaction opens so we never
      // delete inventory items and then throw — leaving items destroyed
      // with no entry recorded.
      if (playing) {
